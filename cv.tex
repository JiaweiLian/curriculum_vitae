...
\leftheader{%
  {\LARGE\bfseries\sffamily \textbf{Jiawei Lian}, \texttt{Curriculum Vitae}}\\
  
  \makefield{\faEnvelope[regular]}{\href{mailto:jiawei.lian@connect.polyu.hk}{\texttt{jiawei.lian@connect.polyu.hk}};\href{mailto:lianjiawei@mail.nwpu.edu.cn}{\texttt{lianjiawei@mail.nwpu.edu.cn}}}\newline
  ...
  \makefield{\faPhone}{\texttt{+86-15978793013, +852-60891479}}
  %% Next line
  \makefield{\faGlobe}{\href{https://scholar.google.com/citations?user=rAPPIPQAAAAJ&hl=en}{\texttt{Google Scholar}}}\newline
  \makefield{\faGlobe}{\href{https://www.researchgate.net/profile/Jiawei-Lian-2}{\texttt{Research Gate}}}
  \makefield{\faGithub}{\href{https://github.com/JiaweiLian}{\texttt{Github}}}
  \makefield{\faHome}{\href{https://jiaweilian.github.io/}{\texttt{Homepage}}}\newline
  \\
  -\textbf{Birth Date}: 01/1997\newline
  -\textbf{Status}: Third-year Ph.D. student, PolyU and NWPU joint training leading to dual Ph.D.\newline
  -\textbf{Research Interest}: AI Safety, Large language model, Computer vision, Remote sensing\newline
  -\textbf{Postal Address}: Room 505, Building CF, The Hong Kong Polytechnic University, Hung Hom, Kowloon, Hong Kong
  }
