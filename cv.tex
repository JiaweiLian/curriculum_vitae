...
\leftheader{%
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:lianjiawei@mail.nwpu.edu.cn}{\texttt{lianjiawei@mail.nwpu.edu.cn}}}
  ...
  -\textbf{Research Interest}: Trustworthy machine learning, Remote sensing, Computer vision\newline
